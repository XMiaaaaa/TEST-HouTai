...
import { MapPin, Phone, Clock, User, Calendar, CheckCircle, XCircle, AlertCircle, BarChart3, X } from 'lucide-react'
...
interface ExamLocationDetailModalProps {
  isOpen: boolean
  onClose: () => void
  locationId: number
}

const ExamLocationDetailModal: React.FC<ExamLocationDetailModalProps> = ({ isOpen, onClose, locationId }) => {
  // 模拟考场数据
      ...
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-6xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <h2 className="text-xl font-bold text-gray-800">
            {examLocation ? `${examLocation.name} 详情` : '考场详情'}
          </h2>
          <button
            onClick={onClose}
        ...
        <div className="p-6 space-y-6">
          {!examLocation ? (
            <div className="flex flex-col items-center justify-center h-64 space-y-4">
              ...
              <button
                onClick={onClose}
                className="bg-gradient-to-r from-blue-500 to-blue-600 text-white px-6 py-3 rounded-lg hover:from-blue-600 hover:to-blue-700 transition-all duration-200 shadow-md hover:shadow-lg"
              >
                关闭
              </button>
            </div>
...
export default ExamLocationDetailModal